...
Unless the initialism is included among the exceptions, spell out the name on first mention, followed immediately by the initialism in brackets.
...
See: [books, films, plays, TV programmes, songs, records, works of art, etc](NewScientistStyleGuideV2.md##books-films-plays-tv-programmes-songs-records-works-of-art-etc)
...
With a c it is a noun, with an s it is a verb. See [practice/practise](NewScientistStyleGuideV2.md##practice-practise). Think "advice" and "advise".
...
See also [West](NewScientistStyleGuideV2.md.md##west-western) for "the Western world", etc.
...
To refer back to stories that appeared in print, use the [print reference](NewScientistStyleGuideV2.md##print-reference) style.
...
See [computer games](NewScientistStyleGuideV2.md##computer-games)
...
Two words (an [exception](NewScientistStyleGuideV2.md##spelling-exceptions) to Oxford [dictionaries](http://oxforddictionaries.com/)), but water-grabber and water-grabbing. The same applies to [land](NewScientistStyleGuideV2.md##land).
...
See [time (units of)](#time%20(units%20of))
...
Government proposals on an issue (an [exception](NewScientistStyleGuideV2.md##spelling-exceptions) to [Oxford dictionaries](http://oxforddictionaries.com/))
...
See [uterus](NewScientistStyleGuideV2.md##uterus)

# World Conservation Union

See [IUCN](NewScientistStyleGuideV2.md##iucn)
